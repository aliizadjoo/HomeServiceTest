    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "cleaning-category.png", false, "نظافت و پذیرایی" },
                    { 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "repairs-category.png", false, "تعمیرات و تأسیسات" },
                    { 3, new DateTime(2025, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), "appliances-category.png", false, "تعمیرات لوازم خانگی" },
                    { 4, new DateTime(2025, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "car-services-category.png", false, "خدمات خودرو" },
                    { 5, new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "beauty-category.png", false, "آرایش و زیبایی" },
                    { 6, new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), "moving-category.png", false, "اسباب‌کشی و حمل و نقل" },
                    { 7, new DateTime(2025, 1, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "gardening-category.png", false, "باغبانی و فضای سبز" }
                });

            migrationBuilder.InsertData(
                table: "Cities",
                columns: new[] { "Id", "CityName", "CreatedAt", "IsDeleted" },
                values: new object[,]
                {
                    { 1, "تهران", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false },
                    { 2, "کرج", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false },
                    { 3, "شیراز", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false },
                    { 4, "اصفهان", new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 3, 4.7000000000000002, "متخصص در امور فنی با ۱۰ سال سابقه کار", 1, new DateTime(2025, 1, 1, 10, 0, 0, 0, DateTimeKind.Unspecified), false, 200000m },
                    ...
                    { 4, 11, 4.0, "تکنسین برق قدرت و هوشمندسازی منازل", 1, new DateTime(2025, 4, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 0m },
                    { 5, 12, 5.0, "متخصص باغبانی و فضای سبز", 3, new DateTime(2025, 5, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 350000m },
                    { 6, 13, 5.0, "کارشناس تعمیرات لوازم خانگی دیجیتال", 2, new DateTime(2025, 6, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 800000m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, 300000m, 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "سرویس دوره‌ای و تعمیر موتور کولر", "cooler-repair.jpg", false, "تعمیر کولر " },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 1, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "نظافت آپارتمان ۸۰ متری، دو خوابه", new DateTime(2025, 2, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 0, 0, 0), 1, false, 3 },
                    { 2, 1, new DateTime(2025, 1, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "یخچال ساید بای ساید صدای ناهنجار می‌دهد", new DateTime(2025, 2, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 14, 30, 0, 0), 3, false, 1 },
                    { 3, 2, new DateTime(2025, 1, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "سرویس کامل کولر آبی برای فصل جدید", new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 0, 0, 0), 2, false, 3 },
                    { 4, 3, new DateTime(2025, 1, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, "شستشوی کامل پژو ۲۰۶ در پارکینگ منزل", new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 16, 0, 0, 0), 4, false, 4 },
                    { 5, 1, new DateTime(2025, 2, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, "هرس درختان حیاط و کاشت گل‌های فصلی", new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 8, 0, 0, 0), 7, false, 3 },
                    { 6, 4, new DateTime(2025, 2, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, "جابجایی اثاثیه به ساختمان مجاور، طبقه سوم با آسانسور", new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 11, 0, 0, 0), 6, false, 2 },
                    { 7, 1, new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "نظافت کامل واحد ۱۲۰ متری", new DateTime(2025, 3, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 0, 0, 0), 1, false, 3 },
                    { 8, 3, new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, "کارواش کامل خودرو در محل", new DateTime(2025, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 16, 0, 0, 0), 4, false, 3 },
                    { 9, 4, new DateTime(2025, 3, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, "تعمیر ماشین لباسشویی دیجیتال", new DateTime(2025, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 11, 0, 0, 0), 6, false, 3 },
                    { 10, 1, new DateTime(2025, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, "سرویس دوره‌ای کولر آبی", new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 10, 30, 0, 0), 2, false, 3 },
                    { 11, 2, new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, "طراحی فضای سبز حیاط ویلا", new DateTime(2025, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 8, 0, 0, 0), 7, false, 3 },
                    { 12, 1, new DateTime(2025, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, "تعمیر یخچال ساید بای ساید", new DateTime(2025, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 14, 0, 0, 0), 3, false, 3 },
                    { 13, 1, new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, "نظافت فوری واحد اداری", new DateTime(2025, 3, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 9, 30, 0, 0), 1, false, 3 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Proposals",
                columns: new[] { "Id", "CreatedAt", "Description", "ExecutionDate", "ExecutionTime", "ExpertId", "IsDeleted", "OrderId", "Price", "Status" },
                values: new object[,]
                {
                    { 1, new DateTime(2025, 1, 11, 0, 0, 0, 0, DateTimeKind.Unspecified), "با تجهیزات کامل نظافتی در زمان تعیین شده حضور خواهم یافت.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 1, false, 1, 550000m, 1 },
                    { 2, new DateTime(2025, 1, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "تضمین نظافت کامل با قیمت مناسب‌تر.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 4, false, 1, 500000m, 1 },
                    { 3, new DateTime(2025, 1, 16, 0, 0, 0, 0, DateTimeKind.Unspecified), "قطعات اصلی و ضمانت ۶ ماهه تعمیرات.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 6, false, 2, 850000m, 2 },
                    { 4, new DateTime(2025, 1, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), "سرویس کامل کولر شامل شستشو و روغن‌کاری.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 2, false, 3, 350000m, 3 },
                    { 5, new DateTime(2025, 2, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), "طراحی باغچه و هرس تخصصی درختان میوه.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 5, false, 5, 650000m, 1 },
                    { 6, new DateTime(2025, 2, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), "دارای ماشین مخصوص و کارگران ورزیده.", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0), 1, false, 6, 1600000m, 1 }
                });

            migrationBuilder.InsertData(
                table: "Reviews",
                columns: new[] { "Id", "Comment", "CreatedAt", "CustomerId", "ExpertId", "IsDeleted", "OrderId", "ReviewStatus", "Score" },
                values: new object[,]
                {
                    { 1, "نظافت بسیار دقیق و منظم انجام شد. کاملاً راضی هستم.", new DateTime(2025, 2, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 1, false, 1, 1, 5 },
                    { 2, "سرویس کولر خوب بود ولی کمی با تاخیر مراجعه کردند.", new DateTime(2025, 1, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 2, false, 3, 1, 4 },
                    { 3, "باغبانی عالی و حرفه‌ای! حیاط ما کاملاً متحول شد.", new DateTime(2025, 3, 5, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 5, false, 5, 1, 5 },
                    { 4, "کار تمیز و به‌موقع انجام شد.", new DateTime(2025, 3, 8, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, false, 7, 1, 5 },
                    { 5, "برخورد محترمانه و کیفیت مناسب.", new DateTime(2025, 3, 12, 0, 0, 0, 0, DateTimeKind.Unspecified), 4, 4, false, 8, 1, 4 },
                    { 6, "تعمیرکار کاملاً مسلط بود و مشکل حل شد.", new DateTime(2025, 3, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), 6, 6, false, 9, 1, 5 },
                    { 7, "سرویس کامل انجام شد، پیشنهاد می‌کنم.", new DateTime(2025, 3, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2, false, 10, 1, 4 },
                    { 8, "طراحی بسیار زیبا و خلاقانه بود.", new DateTime(2025, 3, 22, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 5, false, 11, 1, 5 },
                    { 9, "مشکل یخچال کاملاً برطرف شد.", new DateTime(2025, 3, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), 5, 6, false, 12, 1, 5 },
                    { 10, "سریع و حرفه‌ای، راضی بودم.", new DateTime(2025, 3, 28, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 1, false, 13, 1, 4 }
                });
